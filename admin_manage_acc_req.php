    ...
    <div class="rounded-lg mt-16 bg-white shadow-md">
      ...
      <div class="bg-white shadow-md rounded-lg">
        <div class="p-6">
          ...
          <h5 class="text-lg font-semibold mb-4">User Manage Account</h5>
          <hr class="mb-6">
          ...
          <form method="post">
            ...
            <div class="flex flex-col">
              <label class="block text-sm font-medium text-gray-700 mb-1" for="barangay_name">Barangay Name:</label>
              <input type="text" class="border rounded-md p-2" id="barangay_name" name="barangay_name" value="<?php echo $user['barangay_name']; ?>" readonly>
            </div>
            <div class="flex flex-col">
