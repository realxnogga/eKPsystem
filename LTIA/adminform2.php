            ...
            <div class="card">
                <div class="card-body">
                    <div class="menu flex items-center justify-between">
                        ...
                        <button class="bg-white border-2 border-gray-800 hover:bg-gray-100 px-3 py-2 rounded-md text-gray-800 flex items-center transition-colors duration-300" onclick="location.href='adminform2.php';">
