...
<form method="POST">
  ...
  <?php echo $punong_barangay; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="text-align: center; font-size: 18px; margin-top: 10px; position: absolute; top: 50%; left: 0; right: 0; transform: translateY(-50%); font-weight: normal;">
