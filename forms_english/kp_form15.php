...
<html>
<head>
    <title>KP Form 15 English</title>
 ...
 <div class="top-right-buttons">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">KP Form No. 15</b></h5>
...
ARBITRATION AWARD</b></h3><br>

<p style="text-indent: 2em; font-family: 'Times New Roman', Times, serif; font-size: 18px;">   After hearing the testimonies given and careful examination of the evidence presented in this case, award is hereby made as
follows:             
...
<input type="number" name="received_year" placeholder="year" style="font-size: 18px; text-align: center; border: none; border-bottom: 1px solid black; width: 60px;" min="2000" max="2099" value="<?php echo $existingReceivedYear ?? date('Y') ?>" required>.
    ...
    <input type="text" name="officer" size="25" value="<?php echo $existOfficer; ?>" required list="officerList" style="text-align: center;border: none; border-bottom: 1px solid black; font-family: 'Times New Roman', Times, serif; font-size: 18px;"><br>  Member
</p>
...
<p class="important-warning-text" style="text-align: center; font-size: 18px; font-family: 'Times New Roman', Times, serif; margin-left: 380px; margin-right: auto;">
    <input type="text" name="scenario" size="25" value="<?php echo $existScenario; ?>" required list="officerList" style="text-align: center;border: none; border-bottom: 1px solid black; font-family: 'Times New Roman', Times, serif; font-size: 18px;"><br>Member
</p>
<datalist id="officerList">
    <?php foreach ($names as $name): ?>
        <option value="<?php echo $name; ?>">
