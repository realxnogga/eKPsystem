...
<html>
<head>
    <title>KP Form 22 English</title>
...
<div class="container">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">KP Form No. 22 </b></h5>
...
?>
        ...
        <h5 class="header" style="font-size: 18px; margin-top: 5px;">OFFICE OF THE LUPONG TAGAPAMAYA</h5>
...
<p style="font-size: 18px;"> Respondent/s </p> 
         ...
         <form method ="POST">
                <h3 style="text-align: center;"><b style="font-size: 18px;" > CERTIFICATION TO BAR COUNTERCLAIM</b></h3><br>
...
<script>
    ...
    input.addEventListener("input", function() {
        ...
        this.style.width = (this.value.length + 1) + "ch";
          ...
          <p style="text-align: justify; text-indent: 2.8em; font-size: 18px;"> This <input type="number" name="made_day" placeholder="day" min="1" max="31" style="font-size: 18px; border: none; border-bottom: 1px solid black;" value="<?php echo $existingMadeDay; ?>"> day of
...
<p style="text-align: left; margin-top: 0;font-size: 18px; text-indent: 0em;">
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="font-family: 'Times New Roman', Times, serif; text-align: center; margin-left:  70px;   font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 250px;">Lupon Chairman</label>
