...
<html>
<head>
    <title>KP Form 18 English</title>
 ...
 <div class="top-right-buttons">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">KP Form No. 18 </b></h5>
...
<div class="form-group" style="text-align: justify; text-indent: 0em;">
    ...
    <div class="input-field">
        <p style="font-size: 18px;"> TO:     <br><span style="width: 430px; text-align: center; min-width: 200px; font-size: 18px; border-bottom: 1px solid black; display: inline-block;">
    <?php echo !empty($cNames) ? $cNames : '&nbsp;'; ?></span> <p style="font-family: 'Times New Roman', Times, serif; font-size: 18px; margin-left: 80px;">Complainant/s</p> </div>
...
<form method="POST">
 ...
 type="number" name="day" placeholder="day" min="1" max="31" value="<?php echo $appear_day; ?>" required>  of
                <select style="text-align: center; width:100px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black; font-size: 18px; height: 30px;"
 name="month" required>
 ...
 value="<?php echo $appear_month; ?>" <?php echo ($m === $appear_month) ? 'selected' : ''; ?>><?php echo $appear_month; ?></option>
    ...
    <?php endforeach; ?>
                ...
                <input style="border: none; border-bottom: 1px solid black; border-bottom: 1px solid black; width: 42px; font-size: 18px;"
 type="text" name="year" placeholder="year" size="1"  value="<?php echo isset($appear_year) ? $appear_year : date('Y'); ?>" required> at <input type="time" id="time" name="time" size="5" style="font-size: 18px; border: none; border-bottom: 1px solid black;" value="<?php echo $appear_time; ?>"required>
 ...
 type="number" name="resp_day" placeholder="day" min="1" max="31" value="<?php echo $existingRespDay ?? ''; ?>" required>
                <select style="text-align: center; height: 30px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black; wwidth:44px; font-size: 18px;"
name="resp_month" required>
    <?php foreach ($months as $m): ?>
        <?php if ($id > 0): ?>
            <option style="border: none; border-bottom: 1px solid black; border-bottom: 1px solid black; width:44px;font-size: 18px;"
 value="<?php echo $existingRespMonth; ?>" <?php echo ($m === $existingRespMonth) ? 'selected' : ''; ?>><?php echo $existingRespMonth; ?></option>
        <?php else: ?>
            <option style="border: none; border-bottom: 1px solid black; border-bottom: 1px solid black; width:44px; font-size: 18px;"
 value="<?php echo $m; ?>" <?php echo ($m === $currentMonth) ? 'selected' : ''; ?>><?php echo $m; ?></option>
        <?php endif; ?>
    <?php endforeach; ?>
</select>,
...
<br>
 <p style="text-indent: 2em; font-size: 18px; font-family: 'Times New Roman', Times, serif;">This    <input style="text-align: center; width: 30px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black;  font-size: 18px;" type="number" name="made_day" placeholder="day" min="1" max="31" value="<?php echo $existingMadeDay; ?>"> day of
    <select style="text-align: center; height: 32px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black;  font-size: 18px;" name="made_month" required>
    <?php foreach ($months as $m): ?>
        <?php if ($id > 0): ?>
...
<p class="important-warning-text" style="text-align: center; font-size: 18px; margin-left: 350px; margin-right: auto;">
    ...
    Punong Barangay/Pangkat Chairman</label><br>
               
 
                    </div>
<div style="font-size: 18px; text-indent: 2em;"> 
Notified this <input style="text-align: center; width: 30px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black;  font-size: 18px;" type="text" name="received_day" placeholder="day" size="5" value="<?php echo $existingReceivedDay ?? ''; ?>"> day of
  <select style="text-align: center; height: 30px; border: none; border-bottom: 1px solid black; border-bottom: 1px solid black;  font-size: 18px;" name="received_month" required>
    <?php foreach ($months as $m): ?>
        <?php if ($id > 0): ?>
