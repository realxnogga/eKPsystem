...
<html>
<head>
    <title>KP Form 14 Tagalog</title>
 ...
 <div class="top-right-buttons">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">Pormularyo ng KP Blg. 14</b></h5>
...
?>
        ...
        <h5 class="header" style="font-size: 18px; margin-top: 5px;">TANGGAPAN NG LUPONG TAGAMAPAYAPA</h5>
    </div>
...
<p style="font-family: 'Times New Roman', Times, serif; font-size: 18px;">Sa pamamagitan nito’y nagkakasundo kami na pahatulan ang aming alitan sa Punong Barangay/Pangkat ng Tagapagkasundo (mangyaring guhitang ang di kailangan), at nangangako kami natutupad sa gawad na ihahatol ukol ditto. Ginawa naming ang kasunduang ito ng kusang-loob na may lubos na pagkakaunawa sa anumang kahihinatnan nito.
   ...
   Pinagkasunduan ngayong ika-
    <input type="text" name="made_day" placeholder="day" size="5" style="text-align: center; width: 30px; border: none; border-bottom: 1px solid black; font-family: 'Times New Roman', Times, serif; font-size: 18px;" value="<?php echo $existingMadeDay ?? ''; ?>" required> araw ng
...
<div class="input-field" style="font-family: 'Times New Roman', Times, serif;">
  ...
  <br><br><p style="text-align: justify; font-size: 18px; font-family: 'Times New Roman', Times, serif">PAGPAPATUNAY:</p>

<div style="text-align: justify; text-indent: 2em; font-size: 18px; font-family: 'Times New Roman', Times, serif">
Sa pamamagitan nito'y pinatutunayan ko na ang sinusundang Kasunduan ng Paghahatol ay pinagkasunduan ng mga panig nang Malaya at kusang-loob, matapos kong maipaliwanag sa kanila kung ano ang kasunduang ito at ang mga kahihinatnan nito.
</div>
<br>
