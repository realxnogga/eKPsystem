...
<html>
<head>
    <title>KP Form 21 Tagalog</title>
...
<div class="container">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">Pormularyo ng KP Blg. 21</b></h5>
...
<p style="font-size: 18px;"> (Mga) Ipinagsusumbong </p> 
             ...
             <form method="POST">
                <h3 style="text-align: center;"><b style="font-size: 18px;"> KATIBAYAN UPANG HADLANGAN ANG PAGDULOG SA HUKUMAN</b> </h3><br>
  
    <div>
    <p style="text-indent: 2em; text-align: justify; font-size: 18px;">
    Ito ay nagpapatunay na ag usaping nakasaad sa itaas ay ipinagwalang-saysay alinsunod sa Kautusan may petsang  <input type="number" name="received_day" placeholder="day" min="1" max="31" style="font-size: 18px; border: none; border-bottom: 1px solid black;" value="<?php echo $existingReceivedDay ?? ''; ?>">
                                     araw ng 
 ...
 type="text" name="resp_year" placeholder="year" size="1" value="<?php echo isset($existingRespYear) ? $existingRespYear : date('Y'); ?>" required>
  ...
  para sa (mga) maysumbong 
   ...
   (pangalan) at
   <input style="font-size: 18px; border: none;border-bottom: 1px solid black; display: inline-block;"placeholder="Complaint/s Name" min=" <?php echo !empty($cNames) ? $cNames : '&nbsp;'; ?> " value=" <?php echo !empty($cNames) ? $cNames : '&nbsp;'; ?> ">(pangalan) sanhi ng sinadya o pagtangging humarap para sa pagdinig sa harap ng Punong Barangay/Pangkat ng Tagapagkasundo at dahil dito ang (mga) maysumbong ay hinahadlangang makadulog sa hukuman/tanggapan ng pamahalaan.
      

        <p style="text-align: justify; text-indent: 2em; font-size: 18px;">  Ngayong ika <input style="border: none; border-bottom: 1px solid black; border-bottom: 1px solid black;  font-size: 18px;" type="number" name="made_day" placeholder="day" min="1" max="31" value="<?php echo $existingMadeDay; ?>">  araw ng
        <select name="month" style="font-size: 18px; text-align: center; border: none; border-bottom: 1px solid black; padding: 0; margin: 0; height: 30px; line-height: normal; box-sizing: border-box;" required>
    <?php foreach ($tagalogMonths as $englishMonth => $tagalogMonth): ?>
        <option value="<?php echo $englishMonth; ?>" <?php echo (strcasecmp($englishMonth, date('F')) === 0) ? 'selected' : ''; ?>><?php echo $tagalogMonth; ?></option>
    <?php endforeach; ?>
 ...
 type="text" name="resp_year" placeholder="year" size="1" value="<?php echo isset($existingRespYear) ? $existingRespYear : date('Y'); ?>" required>
    ...
    <label id="pChairman" name="pChairman" size="25" style="text-align: center; margin-left:  530px;   font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 250px;">Kalihim ng Pangkat</label>
...
<p style="text-align: left; margin-top: 0;font-size: 18px; text-indent: 0em;">
    ...
    <label id="punongbrgy" name="punongbrgy" size="25" style="font-family: 'Times New Roman', Times, serif; text-align: center;    font-size: 18px; font-weight: normal; white-space: nowrap; max-width: 200px;">Tagapagpangulo ng Pangkat/Lupon</label>
