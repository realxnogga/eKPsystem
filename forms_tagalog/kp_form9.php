...
<div class="container">
    ...
    <a href="../user_manage_case.php?id=<?php echo $_SESSION['current_complaint_id']; ?>">
        <button class="btn common-button" style="position:fixed; right: 20px; top: 177px;">
            ...
            </div>      <h5> <b style="font-family: 'Times New Roman', Times, serif;">Pormularyo ng KP Blg. 9</b></h5>
...
<div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">
    ...
    <div class="input-field">
        <p style="font-size: 18px;"> KAY: <span style="min-width: 182px; font-size: 18px; border-bottom: 1px solid black; display: inline-block;">
    <?php echo !empty($rspndtNames) ? $rspndtNames : '&nbsp;'; ?></span></p> </div>
                <div>
<p style="font-size: 18px; text-indent:2em;"> (Mga) Ipinagsusumbong</p> </div>

<form method="POST">
<div style="text-align: justify; text-indent: 2em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">
    Sa pamamagitan nito, kayo ay ipinatawag upang personal na humarap sa akin, kasama ang iyong mga testigo, sa ika-
    <input style="font-size: 18px; padding-bottom: 0; border: none; border-bottom: 1px solid black;" type="number" name="day" placeholder="day" min="1" max="31" value="<?php echo $appear_day; ?>" required>araw ng
...
<div style="text-align: justify; text-indent: 2em; margin-left: 1px; margin-top: 1em; font-size: 18px; font-family: 'Times New Roman', Times, serif;">
   Sa pamamagitan nito,  kayo’y binabalaan na ang inyong pagtanggi o kusang di pagharap bilang pagtalima sa patawag na ito, kayo ay  hahadlangan na makapaghain ng ganting-sumbong na magmumula sa nasabing sumbong. 
    <br><p style="text-indent: 2em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">TUPARIN ITO, at kung hindi’y parurusahan kayo sa salang paglapastangan sa hukuman.</p>
</div>


    <div style="height: 30px; text-align: center; text-align: justify; text-indent: 0em; margin-left: 20.5px;text-indent: 2em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;"> Ngayong ika-<input style ="border: none; border-bottom: 1px solid black; font-size: 18px;" type="number" name="made_day" placeholder="day" min="1" max="31" value="<?php echo $existingMadeDay; ?>">
 araw ng
...
<h3 style="text-align: center; font-size: 18px;">
    <b style="font-size: 18px;">ULAT NG OPISYAL</b>
</h3>

<div style="font-size: 18px; text-align: justify; text-indent: 2em; margin-left: 1px;">
    Inihatid ko ang patawag na ito sa ipinagsusumbong na si <?php echo $rspndtNames; ?> noong ika
    ...
    <?php endforeach; ?>
                ...
                <input style ="width: 3em; margin-right: 5px; border: none; border-bottom: 1px solid black; font-size: 18px; font-family: 'Times New Roman', Times, serif;" type="number" name="received_year" placeholder="year" min="<?php echo date('Y') - 100; ?>" max="<?php echo date('Y'); ?>" value="<?php echo date('Y'); ?>">, sa pamamagitan:
               
</select>
                
                <p style="font-size: 18px;text-indent: 0em;">(Isulat ang (mga) pangalan ng (mga) ipinagsusumbong sa karampatan na paraan kung papaano ito ipinahatid)</p>
</div>
    <p style="font-size: 18px;text-indent: 0em; margin-left:1px;">     (Mga) Ipinagsusumbong</p>
...
<div style="font-size: 18px; text-align: justify; text-indent: 0em; margin-left: 20.5px;">
    <p style="font-size: 18px; text-indent: 0em; margin-left: 18px;">
        <input style="border: none; border-bottom: 1px solid black; display: inline-block; font-size: 18px;" type="text" id="scenario1" name="scenario_1" size="15" value="<?php echo ($existingScenario == 1) ? $rspndtName1 : ''; ?>" >  1. siya/sila mismo ang pinagabutan ng patawag, o <br>
        <input style="border: none; border-bottom: 1px solid black; display: inline-block; font-size: 18px;" type="text" id="scenario2" name="scenario_2" size="15" value="<?php echo ($existingScenario == 2) ? $rspndtName2 : ''; ?>" > 2. iniabot sa kanya/kanila ang patawag at ito’y tinanggihan niyang/nillang tanggapin, o  <br>
        <input style="border: none; border-bottom: 1px solid black; display: inline-block; font-size: 18px;" type="text" id="scenario3" name="scenario_3" size="15" value="<?php echo ($existingScenario == 3) ? $rspndtName3 : ''; ?>" > 3. Iniwan ang patawag sa kanyang/kanilang tirahan at inihabilin kay
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px; width: 220px;" type="text" id="scenario3a" placeholder="Enter name" name="scenario_3a" size="15" value="<?php echo ($existingScenario == 3) ? $existScen3 : ''; ?>" > (Pangalan) isang taong may angkop na edad at pagpapasya na naninirahan doon, o<br> 
        <input style="border: none; border-bottom: 1px solid black; display: inline-block; font-size: 18px;" type="text" id="scenario4" name="scenario_4" size="15" value="<?php echo ($existingScenario == 4) ? $rspndtName4 : ''; ?>" >  4. Iniwan ang patawag sa kanyang/kanilang tanggapan/pinagtatrabahuhan at ihihabilin kay
        <input style="border: none; border-bottom: 1px solid black; font-size: 18px; width: 220px;" type="text" id="scenario4a" placeholder="Enter name" name="scenario_4a" size="15" value="<?php echo ($existingScenario == 4) ? $existScen4 : ''; ?>" >, (Pangalan)     Isang taong nararapat mamahala doon.
    </p>
</div><br>
...
<p style="font-size: 18px; font-family: 'Times New Roman', Times, serif; margin-top: 20px; margin-left: 550px;">Opisyal</p>
...
<p style="font-size: 18px;text-indent: 1em; margin-left: 1px;">Tinanggap ng (mga) ipinagsusumbong/(mga) pinagbilinan.</p>
...
<div style="display: inline-block; margin-right: 50px;">
  <div style="border-bottom: 1px solid black; width: 200px; margin-bottom: 10px;">  </div>
    <div style="font-size: 18px;">(Lagda)</div>
</div>

<!-- Second Signature and Date -->
<div style="display: inline-block;">
    <div style="border-bottom: 1px solid black; width: 200px; margin-bottom: 10px;"></div>
    <div style="font-size: 18px;">(Petsa)</div>
</div>
