...
<body>
    <div class="container">
        <div class="paper">
            ...
            <h5> <b style="font-family: 'Times New Roman', Times, serif;">Pormularyo ng KP Blg. 9</b></h5>
                        ...
                        <div class="form-group" style="text-align: justify; text-indent: 0em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">
                            ...
                            <form method="POST">
                                ...
                                <div style="text-align: justify; text-indent: 2em; margin-left: 1px; margin-top: 1em; font-size: 18px; font-family: 'Times New Roman', Times, serif;">
                                    ...
                                    <br>
                                    <p style="text-indent: 2em; margin-left: 1px; font-size: 18px; font-family: 'Times New Roman', Times, serif;">TUPARIN ITO, at kung hindi’y parurusahan kayo sa salang paglapastangan sa hukuman.</p>
                                </div>
