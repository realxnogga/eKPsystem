...
<body class="w-screen h-screen">
    ...
    <section class="h-full w-full bg-gray-300 p-4 ">
        <!-- button section -->
                ...
                <table class="table-auto w-full border-collapse border border-gray-300 font-sans text-gray-700 text-sm">
                    ...
                    <tbody>
                        <tr class="text-center">
                            <td class="px-2 py-0 border border-gray-300">1</td>
                            <td class="px-2 py-0 border border-gray-300">Warren</td>
                            <td class="px-2 py-0 border border-gray-300">San Isidro</td>
                            <td class="px-2 py-0 border border-gray-300">Male</td>
                            <td class="px-2 py-0 border border-gray-300">09656954435</td>
                            <td class="px-2 py-0 border border-gray-300">dfgndfg</td>
                        </tr>
                    </tbody>
                </table>
